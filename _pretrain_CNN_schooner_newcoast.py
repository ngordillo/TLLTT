...
import coast_standard_experiment_settings
...
EXP_NAME = 'loc_'+ str(file_lon) + '_' + str(file_lat) +'_precip_standard'

# ## Define experiment settings and directories

# EXP_NAME = 'alas_200year_winter_ternary_27_large_ERA5'#'smaller_test'#'quadrants_testcase'

imp.reload(coast_standard_experiment_settings)
settings = coast_standard_experiment_settings.get_settings(EXP_NAME)
